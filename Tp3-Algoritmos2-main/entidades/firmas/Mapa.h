...
class Mapa{
    ...
    public:
        ...
        void mostrar_recorrido_jugador(Coordenada * recorrido, int tope_recorrido, int numJugador);

        //PRE: Recibe un casillero y una coordenada.
        //POS: Agrega el casillero si la coordeanda es válida.
        void agregarCasillero(Casillero* casillero, Coordenada coordenada);
        ...
        int obtenerCantDeCasilleros(char tipoDeCasillero);
        ...
        Coordenada obtenerPosicionDeJugador(int jugador);
};
