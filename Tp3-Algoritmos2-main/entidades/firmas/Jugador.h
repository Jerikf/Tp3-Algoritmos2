...
class Jugador{
    ...
    //PRE: Recibe una cedena.
    //POS: Establece el objetivo umplido
    void establecer_objetivo_cumplido(string objetivo_cumplido);
    
    //PRE: -
    //POS: Obtiene el objetivo cumplido.
    string obtener_objetivo_cumplido();

    //PRE: Recibe un enetero positivo 0 0.
    //POS: Establece la cantidad de bombas compradas.
    void establecer_bombas_compradas(int bombas_compradas);

    //PRE: -
    //POS: Devuelve la cantidad de bombas compradas.
