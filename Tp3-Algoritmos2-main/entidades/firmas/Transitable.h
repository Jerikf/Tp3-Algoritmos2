...
class Transitable : public Casillero{
    ...
    public:
        ...
        //PRE: -
        //POS: De haber material lo devuelve o NULL si no hay y deja en NULL al material del casillero.
