...
class Juego
{
    private:
        ...
        void realizar_iteraciones_materiales(Coordenada coordenada, string tipo, int cant_aleatoria, int &cant_casilleros_usados);

        // PRE: -
        // POS: Verificando las condiciones, cambia a una coordenada vlida el casillaro.
        Coordenada cambiar_coordenada();

        //PRE: -
        //POS: Obtiene la cantidad de casilleros transitables usados.
        int obtener_cant_casilleros_transitables_usados();

        // PRE: -
        // POS: Obtiene la cantidad maxima de casilleros transitables disponibles para colocar materiales.
        int obtener_cant_casilleros_disponibles(int cant_casilleros_usados, int cant_aleatoria);
