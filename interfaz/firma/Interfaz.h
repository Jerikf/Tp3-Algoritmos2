...
class Interfaz
{
    private:
        ...
        //POS: Se interactuara con el usuario para que elija a que casillero quiere mover al jugador. Devuelve true si es posivle mover al jugador,
        ...
        //PRE: El mapa debe estar cargado correctamente
        //POS: Se interactuara con el usuario hasta que el jugador quede en una posicion valida para comenzar el juego
