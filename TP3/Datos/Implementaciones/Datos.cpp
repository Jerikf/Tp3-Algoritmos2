...
void Datos::cargar_edificios(){
    ...
    if(!archivo_edificios.fail()){
        ...
        while(archivo_edificios >> nombre_edificio){
            ...
            edificio = new Edificio(nombre_edificio, cant_piedra, cant_madera, cant_metal, cant_max_edificos);
            edificio_2 = new Edificio(nombre_edificio, cant_piedra, cant_madera, cant_metal, cant_max_edificos);
            designar_clase_edificio(edificio, nombre_edificio, cant_piedra, cant_madera, cant_metal, cant_max_edificos);
            designar_clase_edificio(edificio_2, nombre_edificio, cant_piedra, cant_madera, cant_metal, cant_max_edificos);
